...
class GHLAPIClient:
    ...
    async def request(
        ...
        try:
            ...
            return GHLResponse(
                success=False,
                error="Request timeout - GHL API may be slow"
            )
        
        except httpx.ConnectError:
            return GHLResponse(
                success=False,
                error="Connection error - check internet connectivity"
            )
...
class SendMessageTool(BaseTool):
    ...
    async def _arun(self, contact_id: str, message: str, message_type: str = "SMS") -> str:
    ...
    async def _arun(self, contact_id: str, tag: str) -> str:
        ...
        async with GHLAPIClient(ghl_config) as client:
            ...
            if response.success:
                ...
                logger.error("Failed to add tag", contact_id=contact_id, error=response.error)
                return json.dumps({
                    "success": False,
                    "error": response.error
                })
...
class CreateContactNoteTool(BaseTool):
    ...
    async def _arun(self, contact_id: str, note: str, note_type: str = "general") -> str:
        ...
        async with GHLAPIClient(ghl_config) as client:
            ...
            if response.success:
                ...
                logger.error("Failed to create note", contact_id=contact_id, error=response.error)
                return json.dumps({
                    "success": False,
                    "error": response.error
                })
    ...
    async def _arun(self, contact_id: str, updates: Union[str, Dict[str, Any]]) -> str:
        ...
        async with GHLAPIClient(ghl_config) as client:
            ...
            if response.success:
                ...
                logger.error("Failed to update contact", contact_id=contact_id, error=response.error)
                return json.dumps({
                    "success": False,
                    "error": response.error
                })
...
class GetContactDetailsTool(BaseTool):
    ...
    async def _arun(self, contact_id: str) -> str:
        ...
        async with GHLAPIClient(ghl_config) as client:
            ...
            if response.success:
                logger.info("Contact details retrieved successfully", contact_id=contact_id)
                ...
                logger.error("Failed to get contact details", contact_id=contact_id, error=response.error)
                return json.dumps({
                    "success": False,
                    "error": response.error
                })
    ...
    async def _arun(self, query: str, search_type: str = "email") -> str:
        ...
        async with GHLAPIClient(ghl_config) as client:
            ...
            if response.success:
                ...
                logger.info("Contact search completed", query=query, results_count=len(contacts))
                ...
                logger.error("Failed to search contacts", query=query, error=response.error)
                return json.dumps({
                    "success": False,
                    "error": response.error
                })
